...
cpdef eval_cuhk03_cy(float[:,:] distmat, float[:,:] q_feats, float[:,:] g_feats, long long[:] q_pids, long long[:]g_pids,
                     long long[:]q_camids, long long[:]g_camids, long long max_rank, bint use_distmat):

    cdef long long num_q = q_feats.shape[0]
    cdef long long num_g = g_feats.shape[0]
    cdef long long dim = q_feats.shape[1]
...
cpdef eval_market1501_cy(float[:,:] distmat, float[:,:] q_feats, float[:,:] g_feats, long long[:] q_pids, long long[:]g_pids,
                         long long[:]q_camids, long long[:]g_camids, long long max_rank, bint use_distmat):
