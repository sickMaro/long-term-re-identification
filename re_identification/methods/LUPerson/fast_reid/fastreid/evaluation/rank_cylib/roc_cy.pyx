...
# Main interface
cpdef evaluate_roc_cy(float[:,:] distmat, float[:,:] q_feats, float[:,:] g_feats, long long[:] q_pids, long long[:]g_pids,
                  long long[:]q_camids, long long[:]g_camids):
    ...
    cdef:
        ...
        long long valid_pos = 0
        long long valid_neg = 0
        long long ind
